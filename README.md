...
The meaningful changes beyond dependency/build updates were to Sesame's lints/src/sesame_pcr.py and Scrutinizer's scrutils/src/body_cache/mod.rs.
...
The way that dependencies were gathered and selected for hashing also had to be modified to respect dependency ordering and make signatures filesystem agnostic.
...
This port also does not implement sandboxing.
